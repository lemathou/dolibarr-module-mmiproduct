...
class modMMIProduct extends DolibarrModules
{
	...
	public function init($options = '')
	{
		...
		$extrafields->addExtraField('margin_tx_marque', $langs->trans('Extrafield_margin_tx_marque'), 'double', 55, "10,5", 'societe', 0, 0, '', "", 1, '', -1, $langs->trans('ExtrafieldToolTip_margin_tx_marque'), '($objectoffield->array_options["options_margin_coeff"]>0 ?100* ($objectoffield->array_options["options_margin_coeff"]-1)/$objectoffield->array_options["options_margin_coeff"] :NULL)', $conf->entity, 'mmiproduct@mmiproduct', '$conf->mmiproduct->enabled && $conf->global->MMIPRODUCT_PRICEMARGIN');
		...
		$extrafields->addExtraField('margin_min_tx_marque', $langs->trans('Extrafield_margin_min_tx_marque'), 'double', 55, "10,5", 'societe', 0, 0, '', "", 1, '', -1, $langs->trans('ExtrafieldToolTip_margin_min_tx_marque'), '($objectoffield->array_options["options_margin_min_coeff"]>0 ?100* ($objectoffield->array_options["options_margin_min_coeff"]-1)/$objectoffield->array_options["options_margin_min_coeff"] :NULL)', $conf->entity, 'mmiproduct@mmiproduct', '$conf->mmiproduct->enabled && $conf->global->MMIPRODUCT_PRICEMARGIN');
		...
		$extrafields->addExtraField('margin_min_tx_marque', $langs->trans('Extrafield_margin_min_tx_marque'), 'double', 55, "10,5", 'categorie', 0, 0, '', "", 1, '', -1, $langs->trans('ExtrafieldToolTip_margin_min_tx_marque'), '($objectoffield->array_options["options_margin_min_coeff"]>0 ?100* ($objectoffield->array_options["options_margin_min_coeff"]-1)/$objectoffield->array_options["options_margin_min_coeff"] :NULL)', $conf->entity, 'mmiproduct@mmiproduct', '$conf->mmiproduct->enabled && $conf->global->MMIPRODUCT_PRICEMARGIN');
		...
		$extrafields->addExtraField('margin_desired_tx', $langs->trans('Extrafield_margin_desired_tx'), 'double', 55, "10,5", 'product', 0, 0, '', "", 1, '', -1, $langs->trans('ExtrafieldToolTip_margin_effective_tx'), '($objectoffield->array_options["options_margin_desired_coeff"] > 0) ?100* ($objectoffield->array_options["options_margin_desired_coeff"]-1)/$objectoffield->array_options["options_margin_desired_coeff"]  :NULL', $conf->entity, 'mmiproduct@mmiproduct', '$conf->mmiproduct->enabled && $conf->global->MMIPRODUCT_PRICEMARGIN');
		...
		$extrafields->addExtraField('margin_min_tx_marque', $langs->trans('Extrafield_margin_min_tx_marque'), 'double', 55, "10,5", 'product', 0, 0, '', "", 1, '', -1, $langs->trans('ExtrafieldToolTip_margin_min_tx_marque'), '($objectoffield->array_options["options_margin_min_coeff"]>0 ?100* ($objectoffield->array_options["options_margin_min_coeff"]-1)/$objectoffield->array_options["options_margin_min_coeff"] :NULL)', $conf->entity, 'mmiproduct@mmiproduct', '$conf->mmiproduct->enabled && $conf->global->MMIPRODUCT_PRICEMARGIN');
		...
		$extrafields->addExtraField('replenish_reorder_point', $langs->trans('Extrafield_replenish_reorder_point'), 'double', 100, "5,3", 'product', 0, 0, '', "", 1, '', 0, $langs->trans('ExtrafieldToolTip_replenish_reorder_point'), '', $conf->entity, 'mmiproduct@mmiproduct', '$conf->mmiproduct->enabled');
		...
		// Réappro délai
		$extrafields->addExtraField('replenish_delay', $langs->trans('Extrafield_replenish_delay'), 'double', 100, "4,1", 'societe', 0, 0, '', "", 1, '', -3, $langs->trans('ExtrafieldToolTip_replenish_delay'), '', $conf->entity, 'mmiproduct@mmiproduct', '$conf->mmiproduct->enabled');
		...
		// Réception délai
		$extrafields->addExtraField('reception_delay', $langs->trans('Extrafield_reception_delay'), 'double', 100, "4,1", 'societe', 0, 0, '', "", 1, '', -3, $langs->trans('ExtrafieldToolTip_reception_delay'), '', $conf->entity, 'mmiproduct@mmiproduct', '$conf->mmiproduct->enabled');
