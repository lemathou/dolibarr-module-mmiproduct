...
/**
 * \file    test/phpunit/MMIProductFunctionalTest.php
 * \ingroup mmiproduct
...
/**
 * Class MMIProductFunctionalTest
 *
 ...
 *
 * @package Testmmiproduct
 */
class MMIProductFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modMMIProduct')->click();
		} else {
			// Disable the module
			$this->byHref('modMMIProduct')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/mmiproduct/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('mmiproduct/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/mmiproduct/admin/about.php');
		$this->authenticate();
		return $this->assertContains('mmiproduct/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('mmiproductwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modMMIProduct_MMIProductTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modMMIProduct_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
